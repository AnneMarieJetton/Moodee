...
const EditMood = () => {
    ...
    useEffect(() => {
        setLoading(true);
        axios.get(`http://localhost:5555/moods/${id}`)
        .then((response) => {
    ...
    const handleEditMood = () => {
        ...
        setLoading(true);
        axios
            .put(`http://localhost:5555/moods/${id}`, data)
            .then(() => {
                setLoading(false);
                navigate('/');
            })
    ...
    return (
        <div className = 'p-4'>
            <BackButton />
            <h1 className = 'text-3xl my-4'>Edit Mood</h1>
            {loading ? <Spinner /> : ''}
            ...
            <div className = 'my-4'>
                ...
                <button className = 'p-2 bg-sky-300 m-8' onClick = {handleEditMood}>
                    Save
                </button>
            </div>
        </div>
